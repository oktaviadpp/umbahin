            ...
            <div class="card-body">
                <form action="{{ route('transaksi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jarak" class="form-control @error('jarak') is-invalid @enderror" id="exampleFormControlInput1" placeholder="masukkann  jarak">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="berat" class="form-control @error('berat') is-invalid @enderror" id="exampleFormControlInput1" placeholder="masukkann  berat">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="dp" class="form-control @error('dp') is-invalid @enderror" id="exampleFormControlInput1" placeholder="masukkann  dp">
